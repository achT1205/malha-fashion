        ...
        <div class="sidebar-header">
            <router-link :to="{ name: 'e-commerce' }" class="logo">
                <div class="logo-image">
                    <svg viewBox="0 0 74 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>Robes Kabyles</title>
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="noun_Berber_Pattern" fill="#FF5733" fill-rule="nonzero">
                                <path
                            ...
                            <text x="50%" y="90%" font-family="Arial" font-size="8" fill="#000000" text-anchor="middle">Robes Kabyles</text>
                        </g>
                    </svg>
                </div>
                <span class="app-name">MALHA</span>
            </router-link>
